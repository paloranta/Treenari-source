...
const Mediaani = (props) => {
    ...
    return (
        <p className={props.hetki === "alku" ? "markerheader" : "markerheader-yellow"}>{props.hetki === "alku" ? "Mediaaniolotila ennen treeniä: " : "Mediaaniolotila treenin jälkeen: "}{mediaani(props.lista)}</p>        
    )
}
